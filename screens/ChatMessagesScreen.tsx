...
const ChatMessagesScreen = () => {
  ...
  useEffect(() => {
    const fetchReciepientData = async () => {
      try {
        const response = await fetch(
  ...
  const handleSelectMessage = (message) => {
    // check if message already selected
  ...
  console.log(selectedMessages, "th");
  return (
      ...
      >
        {messages.map((item, index) => {
          ...
          if (item.messageType === "image") {
            const baseUrl = "/Users/ranium/Extras/messenger-project/api/files/";
